      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-[#E0FF00]">BB.</h2>
            ...
            <form className="flex flex-col gap-2">
              <input
                ...
                className="bg-gray-800 text-white px-4 py-2 flex-grow border-2 border-[#E0FF00] focus:outline-none focus:ring-2 focus:ring-[#E0FF00] rounded-md"
                required
              />
              <button
                type="submit"
                className="bg-[#E0FF00] text-black px-6 py-2 font-bold hover:bg-[#B3CC00] transition duration-300 rounded-md"
              >
                Subscribe
              </button>
            </form>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Advanced AI", "Voice Recognition", "Smart Home Integration", "Scheduling Assistant"].map((item) => (
                <li key={item} className="hover:text-[#E0FF00] transition duration-300 cursor-pointer">
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-[#E0FF00]">Company</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-[#E0FF00]">Connect</h3>
            <div className="flex space-x-4">
              {[
                ...
                <a
                  key={social.name}
                  href="#"
                  className="text-[#E0FF00] hover:text-[#B3CC00] transition duration-300"
                >
